...
int getCursorPosition(int *rows, int *cols) {
  char buf[32];// cahce data util encounter R
  unsigned int i = 0;
...
int main(){
  ...
  initEditor();
    ...
    editorRefreshScreen();	 //清屏，像 vim 一样。 \x1b 起到转义作用  \x1b[ 开启转义序列 , 2j 在转义序列中表示清屏， see： https://vt100.net/docs/vt100-ug/chapter3.html#ED
